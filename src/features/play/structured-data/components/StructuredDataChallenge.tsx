...
import { structuredDataChallenge } from "../data/challenges";
...
export default function StructuredDataChallenge() {
    ...
    <div className="w-full">
      <AnimatePresence mode="wait">
        {!isFinished ? (
          ...
          >
            <SequenceWorkspace
              challenge={structuredDataChallenge}
          ...
          >
            <SequenceResults
              ...
              icon="🏷️"
              title="Schema Syntax Validated!"
              subtitle="JSON-LD structured data compiled with no warnings!"
            />
          </m.div>
        )}
      </AnimatePresence>
