...
import { accessibilityChallenges } from "../data/challenges";
...
export default function AccessibilityChallenge() {
  ...
  const currentChallenge = accessibilityChallenges[currentIndex];
  const totalCases = accessibilityChallenges.length;
        ...
        {!isFinished ? (
          ...
          >
            <DetectiveResults
              ...
              total={totalCases}
              userAnswers={answers}
              challenges={accessibilityChallenges}
