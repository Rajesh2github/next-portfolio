...
export default function OptimizerResults({
  ...
  onRestart,
  icon = "🏅",
  title = "Optimization Audit Complete!",
  subtitle = "You have met all system requirements",
  ...
  return (
    <div className="w-full text-center">
      ...
      {/* Reusable Achievement review box */}
      <m.div
      ...
      >
        ...
        <div className="p-5 font-mono text-[11px] leading-relaxed text-muted-foreground flex flex-col gap-3">
          ...
          <div>
            <span className="font-bold text-foreground">Complexity rating:</span>{" "}
          ...
          <div className="border-t border-border/20 pt-3 mt-1 text-foreground select-text text-xs">
            <p className="font-bold mb-1.5 uppercase text-emerald-400">🎓 Educational Insights:</p>
