...
import { debugChallenges } from "../data/challenges";
...
export default function DebugHunterChallenge() {
  ...
  const totalCases = debugChallenges.length;
      ...
      <AnimatePresence mode="wait">
        {!isFinished ? (
          ...
          >
            ...
            {/* Render workspace keyed on current index to auto-reset local option states */}
            <DetectiveWorkspace
              key={currentIndex}
