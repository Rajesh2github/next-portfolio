...
import { bundleChallenge } from "../data/challenges";
...
export default function BundleChallenge() {
        ...
        {!isFinished ? (
          ...
          >
            <OptimizerResults
              ...
              icon="📦"
              title="JS Bundle Optimized!"
              subtitle="Your main initial bundle size is now under 200KB!"
            />
          </m.div>
        )}
      </AnimatePresence>
